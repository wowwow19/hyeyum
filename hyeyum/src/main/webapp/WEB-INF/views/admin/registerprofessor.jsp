                            ...
                            <form method="post" action="">
								 <div class="form-row">
									 <div class="form-group col-md-3">
									    ...
									    <input type="text" class="form-control" name="profno" id="profno" placeholder="교번 입력란" required>
								 	 </div>
									 <div class="form-group col-md-3">
							    ...
							    <div class="form-row">
									 ...
									 <div class="form-group col-md-3">
									    ...
									    <input type="text" class="form-control" name="position" id="position" placeholder="직급" required>								 	
									 </div>
									 <div class="form-group col-md-3">
									 ...
									 <div class="form-group col-md-3">
									    ...
									    <input type="text" class="form-control" name="sal" id="sal" placeholder="월급" required>								 	
									 </div>
								 </div>
								 <div class="row">
								 	 <div class="col-md-6">
