...
<jsp:include page="../includes/sidebar.jsp" />
        ...
        <div class="page-wrapper course-list-wrapper">
            ...
            <div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show course-delete-success" role="alert">
			    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			        <span aria-hidden="true">×</span>
			    </button>
			    <strong>성공 - </strong> 강의 삭제을 완료했습니다.
			</div>
			<div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show course-delete-fail" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
                <strong>실패 - </strong> 강의 삭제을 실패했습니다.
            </div>
		 ...
		 <script>
				...
				if(result == "success") {
					$(".course-delete-success").show();
					setTimeout(function() {
					$(".course-delete-success").hide();
					}, 3000);
				} else if(result == "fail") {
					$(".course-delete-fail").show();
					setTimeout(function() {
					$(".course-delete-fail").hide();
					}, 3000);
				};
			</script>
